    ...
    <div className="container px-6 py-10 mx-auto pt-20">
      <div className="mt-5 lg:-mx-0.5 lg:flex lg:items-center gap-20">
        ...
        <div className="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6">
          ...
          <h2 className="block mt-4 text-3xl font-semibold text-gray-800 dark:text-white">Certified Data Engineer | Software Developer specialized in Data-Driven Analytics | Specialized in Cloud Computing</h2>
          <br/>
