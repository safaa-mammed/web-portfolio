...
export const hasDataLayer = () => typeof window !== 'undefined' && window.dataLayer;
      ...
      <div className="mt-5 lg:-mx-0.5 lg:flex lg:items-center gap-20">
        ...
        <div className="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6">
          ...
          <button onClick={() => {
            router.push('/about');
            if (hasDataLayer()) {
              window.dataLayer.push({ event: 'link_click' });
            }
          }} className="px-6 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-color1 rounded-lg hover:bg-color2 focus:outline-none focus:ring focus:ring-opacity-80">
            Learn more about me!
          </button>
        </div>
      </div>
