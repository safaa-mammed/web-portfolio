...
const Resume = () => {
  return (
    ...
    <div className='flex mt-6 text-center justify-center items-center'><button className='px-6 py-2  font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-color1 rounded-lg hover:bg-color2 focus:outline-none focus:ring focus:ring-opacity-80'><a href='/assets/file/Safaa_Kunhi_Mammed_Resume_Update.pdf' download >Download Resume</a></button></div>
